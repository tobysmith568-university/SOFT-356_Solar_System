...
MtlLoader::MtlLoader(FileUtil& _fileUtil)
	: fileUtil(_fileUtil)
{
}
...
void MtlLoader::LoadMaterials(Model& model, std::string& fileLocation)
{
	...
	std::string folder = fileUtil.GetFolder(fileLocation);
	vector<string> fileLines = fileUtil.ReadFileAsLines(fileLocation);// Read in the lines from the file
